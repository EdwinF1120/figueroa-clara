...
const CHECK_ICON = '<svg style ="fill:gray;" onclick="unmarkItem(this)" viewBox="0 0 448 512" width="2em" title="square-check"><path d="M64 32C28.7 32 0 60.7 0 96L0 416c0 35.3 28.7 64 64 64l320 0c35.3 0 64-28.7 64-64l0-320c0-35.3-28.7-64-64-64L64 32z" /></svg>'
...
function addNewItem() {  
  ...
  //Getting the text from the input field for the new li
